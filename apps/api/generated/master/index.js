...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/api/generated/master",
    "api/generated/master",
  ]
...
path.join(process.cwd(), "apps/api/generated/master/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/api/generated/master/schema.prisma")
