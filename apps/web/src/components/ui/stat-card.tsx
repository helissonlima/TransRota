  ...
  return (
    <motion.div
      className={cn(
        ...
        "bg-white rounded-2xl border border-brand-border/60 p-5",
        "shadow-sm",
        glass && "glass",
      )}
      ...
      whileHover={{
        y: -2,
        boxShadow:
          "0 12px 24px -4px rgba(0,0,0,0.06), 0 4px 6px -2px rgba(0,0,0,0.04)",
      }}
    ...
    >
      ...
      <div className="flex items-center gap-2 mt-2">
        {trend !== undefined && (
          <span
            className={cn(
              "inline-flex items-center gap-1 text-[11px] font-bold tracking-wide px-2 py-0.5 rounded-md",
              trend.value >= 0
