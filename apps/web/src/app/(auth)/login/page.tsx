...
const features = [
  { icon: MapPin, title: 'Rastreamento em Tempo Real', desc: 'Monitore sua frota 24/7 com atualizações ao vivo' },
  { icon: Shield, title: 'Checklists Inteligentes', desc: 'Garanta conformidade com inspeções automatizadas' },
  { icon: BarChart2, title: 'Relatórios Avançados', desc: 'Tome decisões baseadas em dados precisos' },
  { icon: Zap, title: 'Alta Performance', desc: 'Sistema responsivo e escalável para frotas de qualquer tamanho' },
];
      ...
      <div className="hidden lg:flex lg:w-[55%] xl:w-[60%] relative bg-sidebar overflow-hidden flex-col">
        ...
        <div className="relative z-10 flex flex-col h-full p-12">
          ...
          >
            ...
            <div>
              <span className="text-white font-bold text-2xl tracking-tight">TransRota</span>
              <div className="text-sidebar-text text-xs">Gestão de Frota e Rotas</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-400 text-lg leading-relaxed mb-12 max-w-md">
              Controle completo de veículos, motoristas e rotas em uma plataforma moderna e intuitiva.
            </p>
              ...
              {features.map((feature, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-slate-500 text-xs mt-0.5">{feature.desc}</div>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          <motion.div
            ...
            className="mt-12"
          >
            <svg viewBox="0 0 400 80" className="w-full max-w-sm opacity-20" fill="none">
              {/* Road */}
              <path d="M0 70 L400 70" stroke="white" strokeWidth="2" strokeDasharray="20 10" />
              {/* Truck body */}
              <rect x="20" y="30" width="120" height="35" rx="4" fill="white" fillOpacity="0.3" />
              <rect x="20" y="30" width="60" height="35" rx="4" fill="white" fillOpacity="0.5" />
              {/* Wheels */}
              <circle cx="60" cy="68" r="10" fill="none" stroke="white" strokeWidth="3" strokeOpacity="0.6" />
              <circle cx="120" cy="68" r="10" fill="none" stroke="white" strokeWidth="3" strokeOpacity="0.6" />
              {/* Window */}
              <rect x="25" y="35" width="30" height="18" rx="2" fill="white" fillOpacity="0.4" />
            </svg>
            <div className="mt-4 text-slate-600 text-xs">
              © {new Date().getFullYear()} TransRota. Todos os direitos reservados.
            </div>
          </motion.div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex items-center gap-3 mb-8 lg:hidden">
            ...
            <span className="font-bold text-xl text-brand-text-primary">TransRota</span>
          </motion.div>

          <motion.div variants={itemVariants}>
            <h2 className="text-3xl font-bold text-brand-text-primary">Bem-vindo de volta</h2>
          ...
          >
            ...
            <motion.div variants={itemVariants}>
              ...
              <input
                ...
                className={cn(
                  'input-base',
                  errors.email && 'border-danger-400 focus:!ring-danger-200 focus:!border-danger-400',
                )}
                autoComplete="email"
              />
              <AnimatePresence>
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="relative">
                <input
                  ...
                  className={cn(
                    'input-base pr-10',
                    errors.password && 'border-danger-400 focus:!ring-danger-200 focus:!border-danger-400',
                  )}
          ...
          >
            Precisa de ajuda?{' '}
            <a href="mailto:suporte@transrota.com.br" className="text-primary-600 hover:underline font-medium">
              Fale com o suporte
            </a>
          </motion.p>
        </motion.div>
